...
Alternatively, you can download and install the .deb package directly from this repository:
- [printrun_1.0_all.deb](packages/printrun_1.0_all.deb)

Install it with: `sudo dpkg -i printrun_1.0_all.deb`
