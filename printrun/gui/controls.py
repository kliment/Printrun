...
def add_extra_controls(self, root, parentpanel, extra_buttons = None, mini_mode = False):
    ...
    speedsizer.Add(wx.StaticText(speedpanel, -1, _("Print speed:")), flag = wx.ALIGN_CENTER_VERTICAL) # removed flag "| wx.ALIGN_RIGHT"
    ...
    speedsizer.Add(root.speed_label, flag = wx.ALIGN_CENTER_VERTICAL) # removed flag "| wx.ALIGN_RIGHT"
    ...
    flowsizer.Add(wx.StaticText(flowpanel, -1, _("Print flow:")), flag = wx.ALIGN_CENTER_VERTICAL) # removed flag "| wx.ALIGN_RIGHT"
    ...
    flowsizer.Add(root.flow_label, flag = wx.ALIGN_CENTER_VERTICAL) # removed flag "| wx.ALIGN_RIGHT"
...
class ControlsSizer(wx.GridBagSizer):
    ...
    def make_standard(self, root, parentpanel, standalone_mode):
        ...
        llts.Add(wx.StaticText(lltspanel, -1, _("XY:")), flag = wx.ALIGN_CENTER_VERTICAL) # removed flag "wx.ALIGN_RIGHT |"
        llts.Add(root.xyfeedc)
        llts.Add(wx.StaticText(lltspanel, -1, _("mm/min Z:")), flag = wx.ALIGN_CENTER_VERTICAL) # removed flag "wx.ALIGN_RIGHT |"
