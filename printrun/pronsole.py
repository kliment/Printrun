...
class pronsole(cmd.Cmd):
    def __init__(self):
        ...
        # AGe manual fix for my large printers since printrun v2.xx isn't able to 
        # import build_dimensions from printrunconf.ini
        ...
        self.settings._add(BuildDimensionsSetting("build_dimensions", "620x300x500+5.00+5.00+0+0+0+0", _("Build dimensions"), _("Dimensions of Build Platform\n & optional offset of origin\n & optional switch position\n\nExamples:\n   XXXxYYY\n   XXX,YYY,ZZZ\n   XXXxYYYxZZZ+OffX+OffY+OffZ\nXXXxYYYxZZZ+OffX+OffY+OffZ+HomeX+HomeY+HomeZ"), "Printer"), self.update_build_dimensions)
