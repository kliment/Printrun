...
rem **     Add your GTK3 binaries installation path to system                         **
...
rem **                                                                                **
rem **     You can find a striped version of GTK3 with needed DLL binary files here:  **
...
rem for the version you don't want to build. Only one active version is allowed.
rem Attention, you can't bundle x32 and x46 in the same Pronterface binary file!
rem You can find a striped version of GTK3 with needed DLL binary files here:
rem  https://github.com/DivingDuck/PrintrunGTK3
rem Download and copy the directory PrintrunGTK3 manually in the root of this Project or clone
rem the included submodule via: git submodules --recursive
...
rem set the path location via Windows system environment variable. 
