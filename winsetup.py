...
data_files = [("Microsoft.VC90.CRT", glob(r'T:\\eclipse-workspace\\Printrun-garyhodgson\\Microsoft.VC90.CRT\\*.*')),
			  ("images", ["images\\arrow_keys.png", "images\\control_z.png","images\\reset.png", "images\\control_xy.png", "images\\arrow_up.png", "images\\arrow_down.png", "images\\zoom_in.png", "images\\inject.png", "images\\zoom_out.png"]),
...
setup(
	...
	options = {
                "py2exe":{
                        "excludes": [
				            "Tkconstants", "Tkinter", "tcl", "numpy", "ssl", "bz2"
				            ]
                }
        }
	)
